...
object WeakEntropyPool {
  ...
  def apply(collector: EntropyCollector): Behavior[Command] = {
    Behaviors.setup { context =>
      ...
      context.system.eventStream ! EventStream.Subscribe(context.messageAdapter[ChannelSignatureReceived](e => WrappedChannelSignature(e.commitments.localCommit.publishableTxs.commitTx.tx.txid)))
