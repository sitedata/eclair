...
class OnionCodecsSpec extends AnyFunSuite {
  ...
  test("encode/decode variable-length (tlv) final per-hop payload with custom user records") {
    val tlvs = TlvStream[OnionTlv](Seq(AmountToForward(561 msat), OutgoingCltv(CltvExpiry(42)), PaymentData(new ByteVector32("eec7245d6b7d2ccb30380bfbe2a3648cd7a942653f5aa340edcea1f283686619"), 0 msat)), Seq(GenericTlv(5432123456L, hex"16c7ec71663784ff100b6eface1e60a97b92ea9d18b8ece5e558586bc7453828")))
  ...
  test("decode multi-part final per-hop payload") {
    ...
    assert(multiPart.paymentSecret === new ByteVector32("eec7245d6b7d2ccb30380bfbe2a3648cd7a942653f5aa340edcea1f283686619"))
    ...
    assert(multiPartNoTotalAmount.paymentSecret === new ByteVector32("eec7245d6b7d2ccb30380bfbe2a3648cd7a942653f5aa340edcea1f283686619"))
  }
